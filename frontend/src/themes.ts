  ...
  forest: {
    ...
    colors: {
      ...
      button: {
        primaryStart: '#7cb342',
        primaryEnd: '#2e7d32',
        primaryShadow: 'rgba(124, 179, 66, 0.3)',
        secondaryBg: 'rgba(255, 255, 255, 0.08)',
        secondaryBorder: 'rgba(255, 255, 255, 0.1)',
        secondaryHoverBg: 'rgba(255, 255, 255, 0.12)',
        dangerBg: 'rgba(239, 83, 80, 0.15)',
        dangerBorder: 'rgba(239, 83, 80, 0.3)',
        dangerHoverBg: 'rgba(239, 83, 80, 0.25)',
      },
      message: {
        infoBg: 'rgba(79, 195, 247, 0.15)',
        infoBorder: 'rgba(79, 195, 247, 0.3)',
      ...
      winModal: {
        bgStart: '#1a2f1a',
        bgEnd: '#0d3d0d',
        titleGradientStart: '#7cb342',
        titleGradientEnd: '#ffd54f',
  ...
  nightglow: {
    ...
    colors: {
      ...
      button: {
        primaryStart: '#00f5d4',
        primaryEnd: '#00bbf9',
        primaryShadow: 'rgba(0, 245, 212, 0.3)',
        secondaryBg: 'rgba(0, 245, 212, 0.08)',
        secondaryBorder: 'rgba(0, 245, 212, 0.15)',
        secondaryHoverBg: 'rgba(0, 245, 212, 0.15)',
        dangerBg: 'rgba(241, 91, 181, 0.15)',
        dangerBorder: 'rgba(241, 91, 181, 0.3)',
        dangerHoverBg: 'rgba(241, 91, 181, 0.25)',
      },
      message: {
        infoBg: 'rgba(0, 187, 249, 0.15)',
        infoBorder: 'rgba(0, 187, 249, 0.3)',
        successBg: 'rgba(0, 245, 212, 0.15)',
        successBorder: 'rgba(0, 245, 212, 0.3)',
        errorBg: 'rgba(241, 91, 181, 0.15)',
        errorBorder: 'rgba(241, 91, 181, 0.3)',
      },
      header: {
      ...
      winModal: {
        bgStart: '#0f0f23',
        bgEnd: '#1a1a3e',
        titleGradientStart: '#00f5d4',
        titleGradientEnd: '#fee440',
        statBg: 'rgba(0, 245, 212, 0.08)',
      },
    },
  },
  colorblind: {
    ...
    colors: {
      ...
      button: {
        primaryStart: '#009e73',
        primaryEnd: '#0072b2',
        primaryShadow: 'rgba(0, 114, 178, 0.3)',
        secondaryBg: 'rgba(0, 0, 0, 0.05)',
        secondaryBorder: 'rgba(0, 0, 0, 0.1)',
        secondaryHoverBg: 'rgba(0, 0, 0, 0.08)',
        dangerBg: 'rgba(213, 94, 0, 0.12)',
        dangerBorder: 'rgba(213, 94, 0, 0.3)',
        dangerHoverBg: 'rgba(213, 94, 0, 0.2)',
      },
      message: {
        infoBg: 'rgba(0, 114, 178, 0.1)',
        infoBorder: 'rgba(0, 114, 178, 0.25)',
        successBg: 'rgba(0, 158, 115, 0.1)',
        successBorder: 'rgba(0, 158, 115, 0.25)',
        errorBg: 'rgba(213, 94, 0, 0.1)',
        errorBorder: 'rgba(213, 94, 0, 0.25)',
      },
      header: {
        gradientStart: '#009e73',
        gradientMid: '#0072b2',
        gradientEnd: '#cc79a7',
      },
      winModal: {
        bgStart: '#e0e0e0',
        bgEnd: '#d0d0d0',
        titleGradientStart: '#009e73',
        titleGradientEnd: '#e69f00',
